...
<div class="grid_10">
    <div class="box round first grid">
        ...
        <!-- Nút Thêm mới -->
		<a href="kmadd.php" class="btn-them">+ Thêm</a>
        ...
        <div class="block">  
			...
			?>
				<tr class="odd gradeX">
                    ...
                    <td>
                        <a href="kmedit.php?id=<?php echo $row['id']; ?>" style="color: green;">Sửa</a> || 
                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" href="kmdel.php?id=<?php echo $row['id']; ?>" style="color: red;">Xóa</a>
                    </td>
				</tr>
			<?php
					}
